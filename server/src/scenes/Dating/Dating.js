...
function greetingScene() {
	const greeting = new Scenes.WizardScene(
		...
		ctx => {
			...
			ctx.reply(
				'Также важно определить конкретную цель: хотите ли вы похудеть, набрать мышечную массу, улучшить выносливость или силу. Поэтому напиши свою цель, так же можешь указать время за которое хочишь ее достичь🤠'
			)
			return ctx.wizard.next()
		},
		async ctx => {
